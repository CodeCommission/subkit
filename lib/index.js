      ...
      Object.keys(schema._subscriptionType._fields).forEach(x => {
        ...
        field.astNode.directives.forEach(y => {
          ...
          subscription.unsubscribe &&
            subscription.unsubscribe(externalSubscriptions[subId] || subId);
        });
      });
    },
    onSubscribe: (req, subId) => {
      const context = {
      ...
      Object.keys(schema._subscriptionType._fields).forEach(x => {
        ...
        field.astNode.directives.forEach(y => {
          ...
          const externalSubscriptionId =
            ...
            subscription.subscribe(null, fieldArgs, context, field);
          if (externalSubscriptionId) {
            externalSubscriptions[subId] = externalSubscriptionId;
          }
          return subId;
        });
      });
